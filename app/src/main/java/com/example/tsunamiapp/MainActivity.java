...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String USGS_REQUEST_URL =
            "https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2021-01-01&endtime=2021-12-01&minmagnitude=7";
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        protected Event doInBackground(URL... urls) {
            ...
            try {
                ...
                Log.e (LOG_TAG, "Problem in getting response from the server", e);
            }
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            try {
                ...
                Log.e (LOG_TAG, "Problem in retrieving the response from server", e);
            }
            finally {
        ...
        /**
         * Convert the {@link InputStream} into a String which contains t  he
